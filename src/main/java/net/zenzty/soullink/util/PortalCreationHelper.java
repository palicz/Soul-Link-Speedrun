...
public class PortalCreationHelper {
     ...
     */
    private static boolean createPortalWithAxis(ServerWorld world, BlockPos startPos,
            Direction.Axis axis) {
        ...
        // Play portal sound
        world.playSound(null, bottomLeft, net.minecraft.sound.SoundEvents.BLOCK_PORTAL_TRIGGER,
